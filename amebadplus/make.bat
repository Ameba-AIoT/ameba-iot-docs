...
if "%1" == "" (
    ...
    echo "..\sphinx_venv\Scripts\sphinx-build.exe -b html %1 build/%1/html/latest -c %1 !tag!"
    python ..\sphinx_venv\Scripts\sphinx-build.exe -b html %1 build/%1/html/latest -c %1 !tag!
) else if "%1" == "cn" (
    echo "..\sphinx_venv\Scripts\sphinx-build.exe -b html %1 build/%1/html/latest -c %1 !tag!"
    python ..\sphinx_venv\Scripts\sphinx-build.exe -b html %1 build/%1/html/latest -c %1 !tag!
) else (
