...
.. figure:: figures/dspcfg_chosen_for_call0_abi.png
   :scale: 80%
   :align: center

Here is the configuration chosen for a Windowed register ABI:

.. figure:: figures/dspcfg_chosen_for_windowed_register_abi.png
   :scale: 80%
   :align: center
...
.. note::
   ...
   - If use CMD line (:file:`auto_build.sh`) to build the project, the configuration file for the automatic compilation script is :file:`project/auto_build /dsp_batch.xml` (HIFI5_PROD_1123_asic_wUPG or HIFI5_PROD_1123_asic_UPG).
...
2. Change the *Library Search Paths* to ``${workspace_loc}/.../lib/audio/prebuilts/$(TARGET_CONFIG)``. Environment variable *$(TARGET_CONFIG)* changes as configuration changes, which assures the right place to find prebuilt libs.
   ...
   .. figure:: figures/dspcfg_library_search_path.png
      :scale: 90%
      :align: center
...
.. figure:: figures/dspcfg_sketch_of_default_dsp_layout.svg
   :scale: 120%
   :align: center

Here is the LSP seen from Xplorer:

.. figure:: figures/dspcfg_lsp_seen_from_xplorer.png
   :scale: 70%
   :align: center
...
.. figure:: figures/dspcfg_sram_dsp_in_default_lsp.png
   :scale: 90%
   :align: center
...
1. If all functions in :file:`ameba_clk_rom.c` needs to be placed in SRAM, right click on this file, and choose ``Build Properties``. And in the new window, set values to *No* for items in the box.
   ...
   .. figure:: figures/dspcfg_project_explorer_of_project_dsp.png
      :scale: 100%
      :align: center
   
   
   .. figure:: figures/dspcfg_set_create_separate_function_sections_no.png
      :scale: 70%
      :align: center

2. Switch to :guilabel:`Addl compiler` tab, add an option as follows:

.. figure:: figures/dspcfg_addl_compiler_tab.png
   :scale: 70%
   :align: center
...
.. figure:: figures/dspcfg_example_of_modification_method.png 
   :scale: 70%
   :align: center

If the DSP accesses a protected address, the following crash log will be printed:

.. figure:: figures/dspcfg_crash_log_printed.png
   :scale: 70%
   :align: center
