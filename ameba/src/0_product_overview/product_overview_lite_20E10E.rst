...
.. tab:: RTL8720E
   ...
   **Introduction**
   ...
   This SoC is a low-power single-chip microcontroller integrating dual RISC cores (Arm® Cortex®-M55 compatible instruction set and RISC-V compatible instruction set) and a digital signal processor (Cadence® Tensilica® HiFi 5 DSP).
   ...
   This SoC integrates the latest specifications of Wi-Fi (Wi-Fi 6) and Bluetooth (Bluetooth 5.2).
   ...
   A variety of peripheral interfaces, including UART, SPI, I2C, LEDC, etc., as well as sensor controllers (such as ADC, Cap-Touch, and thermal) are integrated into SoC.
   Besides, This SoC has rich audio features for smart audio applications with dedicated microphone interfaces (DMIC), built-in voice activity detection (VAD), and I2S.
   ...
   **Block Diagram**
   ...
   .. figure:: figures/block_diagram_lite_nodsp.svg
      :scale: 130%
      :align: center
