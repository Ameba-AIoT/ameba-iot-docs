.. tab:: RTL8720E
   ...
   **How to Use IPC Queue**
   ...
   1. ``IPC_ID_KR4_TO_KM4`` definition in enumeration ``IPC_ID`` in :file:`ipc.h` is shown below. This definition is used in :ref:`Stap 2 <20e_how_to_use_ipc_queue_step_2>`.
   ...
   .. _20e_how_to_use_ipc_queue_step_2:
