...
<<<<<<< HEAD:ameba/src/wifi_tunnel/wifi_tunnel_cn.rst
.. figure:: figures/wifi_tunnel_topology_capacity.svg
=======
.. figure:: ../../../en/wifi_tunnel/figures/wifi_tunnel_topology_capacity.svg
>>>>>>> dbcc9bbd (Revert "[wifi_tunnel]update wifi_tunnel/src/wifi_tunnel_cn.rst"):ameba/src/wifi_tunnel/src/wifi_tunnel_cn.rst
   :scale: 140%
   :align: center
...
1. 获取SDK和R-Mesh WLAN lib：

   a. 索取R-Mesh WLAN lib：联系 <claire_wang@realsil.com.cn>
   b. 下载SDK：`IoT SDK <https://github.com/Ameba-AIoT/ameba-rtos>`_

2. 替换文件和编译image：

   a. 替换 ``{sdk}/amebadplus_gcc_project/project_km4/asdk/lib/application`` 路径下的:file:`lib_wifi_inic_ap.a`
   b. 替换 ``{sdk}/amebadplus_gcc_project/project_km0/asdk/lib/application`` 路径下的:file:`lib_wifi_common.a`，:file:`lib_wifi_fw.a`和:file:`lib_wifi_inic_np.a`
   c. 在 ``{sdk}/component/wifi/driver/include/autoconf_8721da.h`` 中打开如下宏，然后编译image即可使用R-Mesh
