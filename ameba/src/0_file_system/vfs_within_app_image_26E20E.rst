.. tab:: RTL8726EA/RTL8720EA
    ...
    2. Name the bin file :file:`fatfs.bin` and place it in ``{SDK}\amebalite_gcc_project``.
    ...
    The application firmware (:file:`kr4_km4_app.bin`) will include a read-only VFS area in FAT format, which will be mounted during the startup process.
