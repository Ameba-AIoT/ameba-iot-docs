.. tab:: RTL8730E
    ...
    2. Name the bin file :file:`fatfs.bin` and place it in ``{SDK}\amebasmart_gcc_project``.
    ...
    The application firmware (:file:`km0_km4_ca32_app.bin`) will include a read-only VFS area in FAT format, which will be mounted during the startup process.
