.. tab:: RTL8726E/RTL8720E
   ...
   If the anti-rollback function is enabled to ensure that the version of the bootloader can only be
   incrementing but cannot be rolled back, the version of the bootloader needs to be changed before compiling.
