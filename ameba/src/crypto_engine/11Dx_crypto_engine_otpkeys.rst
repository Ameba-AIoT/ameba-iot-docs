.. tab:: RTL8711Dx
   ...
   Among these five keys, there are one secure key and two non-secure keys available for SHA HAMC to choose from, and four secure keys and non-secure keys available for AES to choose from. Refer to the table below for specific information.

   .. figure:: figures/opt_keys_for_crypto_rtl8711d.svg
      :scale: 120%
      :align: center
