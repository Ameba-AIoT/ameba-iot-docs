...
.. table::
   ...
   +---------+---------------+---------------+---------------+---------------+
   | Station | UDP Tx (Mbps) | UDP Rx (Mbps) | TCP Tx (Mbps) | TCP Rx (Mbps) |
   +=========+===============+===============+===============+===============+
   | Layer1  | 53.8          | 39.9          | 17.0          | 15.7          |
   +---------+---------------+---------------+---------------+---------------+
   | Layer2  | 18.7          | 19.3          | 9.6           | 10.0          |
   +---------+---------------+---------------+---------------+---------------+
   | Layer3  | 12.0          | 10.1          | 6.9           | 7.0           |
   +---------+---------------+---------------+---------------+---------------+
   | Layer4  | 8.7           | 6.8           | 5.4           | 5.2           |
   +---------+---------------+---------------+---------------+---------------+
   | Layer5  | 7.5           | 5.5           | 4.4           | 4.3           |
   +---------+---------------+---------------+---------------+---------------+
