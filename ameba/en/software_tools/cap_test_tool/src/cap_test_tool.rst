...
.. table:: Default UART pins of different ICs
   ...
   +----------------------+---------------------------------------+
   | Ameba SoC            | Default UART pins                     |
   +======================+=======================================+
   | RTL8730E             | - CAP_UART_RX = PB10                  |
   |                      | - CAP_UART_TX = PB11                  |
   +----------------------+---------------------------------------+
   | | RTL8726EA          | - CAP_UART_RX = PA0                   |
   | | RTL8713EC          | - CAP_UART_TX = PA1                   |
   | | RTL8720EA          |                                       |
   | | RTL8710EC          |                                       |
   +----------------------+---------------------------------------+
   | | RTL8721Dx          | - CAP_UART_RX = PB30                  |
   | | RTL8711Dx          | - CAP_UART_TX = PB31                  |
   +----------------------+---------------------------------------+
...
.. table:: General configuration
   ...
   +----------------------+----------------------------------------------------------+-----------------------------------------------------------------------------------------------------------+
   | Clock Source         | - RTL8730E/RTL8726EA/RTL8713EC/RTL8720EA/RTL8710EC: OSC  | Sample clock:                                                                                             |
   |                      |                                                          |                                                                                                           |
   |                      | - RTL8721Dx/RTL8711Dx:                                   | - RTL8730E/RTL8726EA/RTL8713EC/RTL8720EA/RTL8710EC: OSC 131kHz                                            |
   |                      |                                                          |                                                                                                           |
   |                      |   - OSC                                                  | - RTL8721Dx/RTL8711Dx:                                                                                    |
   |                      |   - XTAL                                                 |                                                                                                           |
   |                      |                                                          |   - OSC 131kHz                                                                                            |
   |                      |                                                          |   - XTAL 2MHz Divider                                                                                     |
   +----------------------+----------------------------------------------------------+-----------------------------------------------------------------------------------------------------------+
   | Divider              | 1MHz/500KHz/250KHz/167KHz/125KHz/62.5KHz/31.25KHz        | Sample clock for XTAL 2MHz Divider: max. sample clock is 1MHz, charge time t = 0.us.                      |
   +----------------------+----------------------------------------------------------+-----------------------------------------------------------------------------------------------------------+
   | Proofing Enable      | Disabled                                                 | - RTL8730E/RTL8726EA/RTL8713EC/RTL8720EA/RTL8710EC: Not supported                                         |
   |                      |                                                          |                                                                                                           |
   |                      |                                                          | - RTL8721Dx/RTL8711Dx: Enabled not supported now                                                          |
   +----------------------+----------------------------------------------------------+-----------------------------------------------------------------------------------------------------------+
   | Filter Enable        | - RTL8730E/RTL8726EA/RTL8713EC/RTL8720EA/RTL8710EC: 0    | - RTL8730E/RTL8726EA/RTL8713EC/RTL8720EA/RTL8710EC: Not supported                                         |
   |                      |                                                          |                                                                                                           |
   |                      | - RTL8721Dx/RTL8711Dx:                                   | - RTL8721Dx/RTL8711Dx:                                                                                    |
   |                      |                                                          |                                                                                                           |
   |                      |   - 0                                                    |   - 0: Filter disabled                                                                                    |
   |                      |   - 1                                                    |   - 1: Filter enabled                                                                                     |
   +----------------------+----------------------------------------------------------+-----------------------------------------------------------------------------------------------------------+
   | Average Enable       | - RTL8721Dx/RTL8711Dx:                                   | - RTL8730E/RTL8726EA/RTL8713EC/RTL8720EA/RTL8710EC: Not supported                                         |
   |                      |                                                          |                                                                                                           |
   |                      |   - 0                                                    | - RTL8721Dx/RTL8711Dx: Average filter for periodic noise (50Hz or 60Hz), active when filter enabled       |
   |                      |   - 1                                                    |                                                                                                           |
   |                      |                                                          |   - 0: Disabled                                                                                           |
   |                      |                                                          |   - 1:  Enabled                                                                                           |
   +----------------------+----------------------------------------------------------+-----------------------------------------------------------------------------------------------------------+
   | Average MDEC         | RTL8721Dx/RTL8711Dx: 0~32767                             | - RTL8730E/RTL8726EA/RTL8713EC/RTL8720EA/RTL8710EC: Not supported                                         |
   |                      |                                                          |                                                                                                           |
   |                      |                                                          | - RTL8721Dx/RTL8711Dx: Active when average filter enabled                                                 |
   |                      |                                                          |                                                                                                           |
   |                      |                                                          |   - 0: Disable average filter                                                                             |
   +----------------------+----------------------------------------------------------+-----------------------------------------------------------------------------------------------------------+
   | Median Filter        | - RTL8721Dx/RTL8711Dx:                                   | - RTL8730E/RTL8726EA/RTL8713EC/RTL8720EA/RTL8710EC: Not supported                                         |
   |                      |                                                          |                                                                                                           |
   |                      |   - 0                                                    | - RTL8721Dx/RTL8711Dx: active when filter enabled                                                         |
   |                      |   - 1                                                    |                                                                                                           |
   |                      |                                                          |   - 0: Median filter disabled                                                                             |
   |                      |                                                          |   - 1: Median filter enabled                                                                              |
   +----------------------+----------------------------------------------------------+-----------------------------------------------------------------------------------------------------------+
   | IIR Enable           | - RTL8721Dx/RTL8711Dx:                                   | - RTL8730E/RTL8726EA/RTL8713EC/RTL8720EA/RTL8710EC: Not supported                                         |
   |                      |                                                          |                                                                                                           |
   |                      |   - 0                                                    | - RTL8721Dx/RTL8711Dx: IIR filter for high frequency white noise, active when filter enabled              |
   |                      |   - 1                                                    |                                                                                                           |
   |                      |                                                          |   - 0: IIR filter disabled                                                                                |
   |                      |                                                          |   - 1: IIR filter enabled                                                                                 |
   +----------------------+----------------------------------------------------------+-----------------------------------------------------------------------------------------------------------+
   | IIR A1               | RTL8721Dx/RTL8711Dx: 0~65535                             | - RTL8730E/RTL8726EA/RTL8713EC/RTL8720EA/RTL8710EC: Not supported                                         |
   |                      |                                                          |                                                                                                           |
   |                      |                                                          | - RTL8721Dx/RTL8711Dx: active when IIR filter enabled                                                     |
   +----------------------+----------------------------------------------------------+-----------------------------------------------------------------------------------------------------------+
   | IIR Gain             | RTL8721Dx/RTL8711Dx: 0~65535                             | - RTL8730E/RTL8726EA/RTL8713EC/RTL8720EA/RTL8710EC: Not supported                                         |
   |                      |                                                          |                                                                                                           |
   |                      |                                                          | - RTL8721Dx/RTL8711Dx: active when IIR filter enabled                                                     |
   +----------------------+----------------------------------------------------------+-----------------------------------------------------------------------------------------------------------+
...
.. table:: Channel configuration
   ...
   +===================+============================================================+============================================================================================+
   | Mbias             | - RTL8730E/RTL8726EA/RTL8713EC/RTL8720EA/RTL8710EC: 1~63   | Sensitivity setting for each channel.                                                      |
   |                   |                                                            |                                                                                            |
   |                   | - RTL8721Dx/RTL8711Dx: 1~255                               | 1 LSB = 0.25uA.                                                                            |
   |                   |                                                            |                                                                                            |
